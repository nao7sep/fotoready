...
- Queue/error UX with active-task reporting, consistent Not saved / Saved / Description generated / Slug generated / Needs attention task states, transient Saving / Waiting to save / Generating description / Generating slug labels during active work, retry/dismiss actions, renderer log forwarding, import-boundary checks, and a TypeScript production build check.
