 ...
 * (SegmentedRadioGroup, useListbox). Given the current item index and the item
 * count, returns the index a directional key should move to.
 *
 ...
 * empty set. The components map their own keys onto a direction (e.g. a listbox
 * uses Up/Down, a segmented group also uses Left/Right) and keep the DOM focus
 * movement, which is verified by manual QA.
 */
