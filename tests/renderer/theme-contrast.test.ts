...
// Every color pair the stylesheet draws must meet WCAG AA in both themes (app-chrome conventions,
// Theme): 4.5:1 for text, 3:1 for a field's outline and for focus, selection, and status marks.
