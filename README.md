...
- Sharp/Piscina runtime with crop/rotate/resize/tone/LUT/conceal/watermark ops, same-as-original output defaults, JPEG quality assumption from in-memory JPEG bytes only when enabled, transparency flatten controls, metadata strip/inject flows, and safer unsupported-format handling.
