...
// and since Safari 27 so does focus a script moves after keyboard use. The message
...
// may ring; a container the covering rule in app.css reaches; or a site listed
...
const COVERING_STYLESHEET = "src/renderer/styles/app.css";
...
const EXPLAINED: Record<string, { kind: Site["kind"]; reason: string }> = {
  "src/renderer/components/modals/focus-trap.ts": {
    kind: "attribute",
