// The interface languages FotoReady ships, in the order the Settings picker
// lists them after System: Latin-script languages alphabetically by their own
// names, then Cyrillic, then CJK. Each tag names a catalogue in ./locales. The
// main process and the renderer both import this module, so they resolve the
// computer's language and the saved choice the same way.
//
...
export function systemLanguage(preferredLanguages: readonly string[]): Language {
...
// What the main process tells the renderer: the language both halves speak and
