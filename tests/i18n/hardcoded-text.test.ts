...
const READ_ATTRIBUTES = new Set([
  ...
  "alt",
  "label",
  // FotoReady's own components that hand a prop to one of the attributes above or show it.
  "ariaLabel",
  "buttonLabel",
  "dismissLabel",
  "emptyLabel",
...
const LITERAL_TEXT = new Set([
  ...
  "GitHub",
  "Gemini",
  // Image format names, used as section headings.
  "JPEG",
  "PNG",
  "WebP",
  "AVIF",
  // The author's name, copyright line and licence identifier in About.
  "Yoshinao Inoguchi",
  "© 2026 Yoshinao Inoguchi",
  "GPL-3.0-or-later",
  // A font family name, shown as an example value.
  "Inter",
  // Axis labels for position sliders.
  "X",
  "Y",
  // The pixel unit after a target size.
  "px",
]);
